...
public class BugJMORK1Test extends TestCase {

	public void testJMORK1() throws Exception {
		InputStreamReader reader = new InputStreamReader(getClass().getResource("/abook_JMORK-1.mab").openStream());
		...
		assertEquals(1,dict1.getAliasCount());
		assertSame(ScopeTypes.ATOM_SCOPE,dict1.getDefaultScope());
		assertEquals("0",dict1.getValue("80"));
		
		Dict dict2 = dicts.get(2);
		assertEquals(5,dict2.getAliasCount());
